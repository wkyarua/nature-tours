...
<section style="position: relative; height: 100vh; display: flex; align-items: center; justify-content: center; overflow: hidden;">
    ...
    <video autoplay loop muted playsinline poster="images/rembe.jpeg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: 0; pointer-events: none;">
    ...
    <div class="container animate-up text-center" style="position: relative; z-index: 2;">
        <h2 style="color: var(--primary-yellow); font-size: 1.5rem; letter-spacing: 3px; font-weight: 400; margin-bottom: 10px;">WELCOME TO NATUREWISE</h2>
        <h1 style="color: white; font-size: 4.5rem; text-shadow: 2px 4px 15px rgba(0,0,0,0.6); margin-bottom: 20px;">Your Greatest Adventure Is Waiting.</h1>
        ...
        <a href="booking.php" class="btn btn-outline" style="margin-left: 15px;">Start Here</a>
    </div>
</section>

<section class="section-padding container">
    <div class="text-center animate-up" style="margin-bottom: 60px;">
        <span style="color: var(--primary-orange); font-family: 'Jost'; font-weight: 600; letter-spacing: 2px;">YOUR JOURNEY BEGINS HERE</span>
        <h2 style="margin-top: 10px;">Tailor-Made African Safaris</h2>
